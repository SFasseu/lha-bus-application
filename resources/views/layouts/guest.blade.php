...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('{{asset('/material')}}/assets/img/lock.jpg'); background-size: cover; background-position: top center;">
   @yield('content')
</div>
    </div>
      <footer class="footer">
        <div class="container">
          <div class="copyright float-center">
            ...
            , Developed by LHA-SESSION-JAN-2024
        </div>
        </div>
      </footer>
    </div>
